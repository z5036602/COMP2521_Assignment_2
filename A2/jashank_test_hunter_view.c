...
main (void)
{
	...
	do {////////////////////////////////////////////////////////////////
		char *symbols[] = {
			"hv_new", "hv_drop", "hv_get_round", "hv_get_player",
			"hv_get_score", "hv_get_health", "hv_get_location",
			"hv_get_trail", "hv_get_dests", "hv_get_dests_player"
		};
	...
	do {////////////////////////////////////////////////////////////////
		...
		TEST (n_edges == 5,
			"hv_get_dests_player(hv, Godalming, road): 5 locations");
	...
	do {////////////////////////////////////////////////////////////////
		...
		TEST (n_edges == 7,
			"hv_get_dests_player(hv, Godalming, sea): 7 locations");
	...
	do {////////////////////////////////////////////////////////////////
		...
		TEST (n_edges == 1,
			"hv_get_dests_player(hv, Godalming, rail): 1 location");
		EXPECT_TO_SEE (ATHENS);
	...
	do {////////////////////////////////////////////////////////////////
		...
		TEST (hv_get_health (hv, PLAYER_LORD_GODALMING) == 9,
	...
	do {////////////////////////////////////////////////////////////////
		...
		size_t n_edges;
		location_t *edges = hv_get_dests_player (
			hv, &n_edges, PLAYER_DRACULA, true, false, true);
		bool seen[NUM_ALL_LOCATIONS] = {false};
		for (size_t i = 0; i < n_edges; i++) {
			if (! valid_location_p (edges[i]))
				eprintf ("... invalid location '%d'", edges[i]);
		...
		TEST (n_edges == 0,
			"hv_get_dests_player(hv, Dracula, road, sea): 0 locations");
	...
	do {////////////////////////////////////////////////////////////////
		...
		TEST (n_edges == 3,
			"hv_get_dests_player(hv, Dracula, road, sea): 3 locations");
